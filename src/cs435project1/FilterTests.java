...
public class FilterTests {
	public static void main(String[] args) throws IOException{
		/*BloomFilterRan myFilter = new BloomFilterRan(32,2);
		myFilter.add("map");
		myFilter.add("table");
		myFilter.add("browns");
		myFilter.add("bingo");
		...
		BloomJoin bloomJ = new BloomJoin("C:\\Users\\Sam\\workspace\\cs435project1\\src\\cs435project1\\Relation3.txt",
				"C:\\Users\\Sam\\workspace\\cs435project1\\src\\cs435project1\\Relation4.txt");
		
		bloomJ.join("C:\\Users\\Sam\\workspace\\cs435project1\\src\\cs435project1\\test.txt");
	}
}
